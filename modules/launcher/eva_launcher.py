...
SERVICES = {
    ...
    "activity_tracker_agent":{"cmd": f"cd {EVA_HOME}/modules/activity-tracker-agent && python3 main.py", "port": 8794,  "health": "http://localhost:8794/health", "label": "activity-tracker-agent"},
}
