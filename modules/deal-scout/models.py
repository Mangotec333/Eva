"""
EVA Deal Scout — Pydantic models (v6)
...
class Deal(BaseModel):
    ...
    # v6 NEW scoring dimensions
    owner_neglect_score: float = 0.0     # damage score from operator absence (0–100, higher = more damage)
    adobe_platform_risk_score: float = 0.0  # risk of Adobe releasing native competitor (0–100, higher = more risk)
    ...
    # Score buckets — rationales grouped by category (v6)
    score_buckets: dict = {}             # keys: "Financial", "Moat & Defense", "Risk & Mitigation",
                                         #       "Platform Risk", "Operator Profile"
    ...
    # v6 NEW financial field
    breakeven_months_with_draw: float = 0.0  # months to recoup down payment while drawing $6K/mo salary
