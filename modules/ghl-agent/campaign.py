...
TOUCHES: list[dict] = [
    {
        ...
        "body": (
            ...
            "It reads every listing. It scores each one. It surfaces the few that matter.\n"
            "\n"
            "See how it works:\n"
            f"{LANDING_URL}\n"
        ),
    ...
    },
    {
        ...
        "body": (
            ...
            "\n"
            "Eva read 400 listings that week.\n"
            "It flagged three that cleared the net target.\n"
            "One went under contract.\n"
            "\n"
            "The operator looked at three deals, not four hundred.\n"
            "\n"
