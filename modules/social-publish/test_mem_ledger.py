"""
EVA Social-Publish — offline memory + ledger test (stdlib only, zero network).
...
Run: python modules/social-publish/test_mem_ledger.py
"""
...
def test_memory_and_ledger() -> None:
    ...
    os.environ["SOCIAL_PUBLISH_DB"] = db
