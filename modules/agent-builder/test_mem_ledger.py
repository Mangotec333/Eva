"""
EVA Agent Builder — offline memory + ledger test (stdlib only, zero network).
...
Run: python modules/agent-builder/test_mem_ledger.py
"""
...
def test_memory_and_ledger() -> None:
    ...
    os.environ["AGENT_BUILDER_DB"] = db
