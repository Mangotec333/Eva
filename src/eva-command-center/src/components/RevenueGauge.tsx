    ...
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col gap-3">
        ...
        <div className="flex justify-between px-0">
          {[0, 25, 50, 75, 100].map(tick => (
            <div key={tick} className="flex flex-col items-center">
              ...
              <span className="font-mono text-[10px] text-gray-500">{tick}%</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 pt-3">
        <div className="grid grid-cols-3 gap-2">
          {breakdown.map(item => (
            <div key={item.label} className="bg-gray-100/60 rounded p-2">
      ...
      {/* Gap indicator */}
      <div className="flex items-center justify-between bg-gray-100/40 border border-gray-200/50 rounded px-3 py-2">
        <span className="font-mono text-xs text-gray-500">Gap to threshold:</span>
